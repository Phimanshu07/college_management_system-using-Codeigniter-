   ...
   <div class="col-md-12 " >
     <div class="form-inline">
       <label class="col-md-3 control-label" >Name</label>
          ...
          <?php echo form_input(['name'=>'studentname','class'=>'form-control col-md-9 md-form','placeholder'=>'Student Name','value'=>set_value('studentname')]) ?>
   ...
   <div class="col-md-12 my-auto" >
     <div class="form-inline">
       <label class="col-md-3 control-label" >Course</label>
          ...
          <?php echo form_input(['value'=>set_value('course'),'name'=>'course','class'=>'form-control col-md-9 md-form','placeholder'=>'course']) ?>
